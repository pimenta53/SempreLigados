...
{
    LinkedList<PerfilArrList> listaOrdNif;
    ArrayList<PerfilArrList> listaOrdNome;
   
    public SoLigados() {
        listaOrdNif = new LinkedList<PerfilArrList>();
   ...
   public void timeProcurasNome() {
    ...
    public void timeMensagem() {
        ArrayList<Long> l= new ArrayList<Long>();
        String nif = "9000011000";
        String msg = "asd";
        long nR = Long.parseLong(nif), startTime, endTime;
        long nD = nR;
        int i = 0;
        for (i=0;i<100; i++){ 
            nD+=(20);
            startTime = System.nanoTime();
            enviarMensagem(msg,nD,nR);
            endTime = System.nanoTime();
            l.add(endTime - startTime); 
        }
        i=0;
