...
public class HashMapMsg implements Serializable
{
 
    private HashMap<Integer,MsgRem> mensagens;
    
     public HashMapMsg() {
        mensagens=new HashMap<Integer,MsgRem>();
    }
    public HashMapMsg(HashMap<Integer,MsgRem> msgs) {
          mensagens= new HashMap<Integer,MsgRem> ();
          Long nif;
    ...
    public HashMapMsg(HashMapMsg m){
        mensagens= new HashMap<Integer,MsgRem> ();
        Long nif;
    ...
    public boolean equals(Object o) {
        ...
        if ((o==null) || (o.getClass()!=this.getClass()))
            return false;
        HashMapMsg ml = (HashMapMsg) o;
        return this.mensagens.equals(ml.getMensagens());
    }
   
   public HashMapMsg clone(){return  new HashMapMsg(this);}
}